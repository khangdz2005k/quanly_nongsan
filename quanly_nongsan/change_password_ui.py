    ...
    return rx.center(
        rx.vstack(
            ...
            rx.vstack(
                ...
                rx.input(value=State.old_password, 
                    on_change=State.set_old_password,
                    width = "100%",
                    bg = "#F0F4F8"),

                rx.text("Mật khẩu mới", size = "1"),
                rx.input(value=State.new_password, 
                    on_change=State.set_new_password, 
                    width = "100%", 
                    bg = "#F0F4F8"),

                rx.text("Xác nhận mật khẩu mới", size = "1"),
                rx.input(value=State.confirm_new_password,
                    on_change=State.set_confirm_new_password,
                    width = "100%",
                    bg = "#F0F4F8"),

                rx.button("Đổi mật khẩu", on_click=State.change_password, bg = "red", color = "white", cursor = "pointer"),
                width = "100%"
            ),
             width = "100%",
             padding = "18px",
